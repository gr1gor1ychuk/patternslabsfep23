...
persons = {
    1: Student(id=1, first_name="Leo", last_name="Messi", role=Roles.STUDENT),
    2: Professor(id=2, first_name="Cristiano", last_name="Ronaldo", role=Roles.TEACHING_STAFF,
                 unique_attribute="Head teacher"),
}
